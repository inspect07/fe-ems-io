<template>
  ...
  >
    <div class="info flex flex-col items-start lg:w-3/6 m-auto">
      ...
      <h4 class="text-lg pb-2 f-gray dark:text-white duration-1000">
        Fullstack Developer
      </h4>
      <h5 class="text-sm pb-12 f-gray dark:text-white duration-1000">
      ...
      <div>
        ...
        >
          ...
          <span
            ><font-awesome-icon class="w-4" :icon="['fas', 'paper-plane']"
          /></span>
        </a>
      </div>
    </div>
...
.img-first {
  margin-left: 12px;
  height: 350px;
  clip-path: polygon(25% 0%, 100.5% 0%, 73% 100%, 0% 100%);
}
